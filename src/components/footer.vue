...
<template>
        ...
        <div class="fcontainer">
            <p>
                博客已运行<span v-html='longTime'>{{longTime}}</span><span class="timeJump">(●'◡'●)ﾉ♥</span>
						...
						<a href="https://beian.miit.gov.cn/" target="_blank">辽ICP备2022004564号-1</a>
            <p>
                托管于 <a href="https://zqq520.github.io/show/" target="_blank">GitHub</a>.
            </p>
   
            <p>
                <span>Made with</span> <img class="fheart" src="static/img/heart02.png"/>  <span>by zqq.</span>
            </p>
        </div>
    </div>
    <!-- Zqq的 -->
    <div v-else class="footBack footBackHui">
        ...
        <div class="fcontainer">
            ...
            <p>
                托管于 <a href="https://zqq520.github.io/show/" target="_blank">GitHub</a>. 提供网站统计服务.
            </p>
						<a href="https://beian.miit.gov.cn/" target="_blank">辽ICP备2022004564号-1</a>
    ...
    export default {
        ...
        methods: { //事件处理器
            runTime:function(){//运行倒计时
                var that = this;
                var oldTime =new Date('2022/03/01 00:00:00');
